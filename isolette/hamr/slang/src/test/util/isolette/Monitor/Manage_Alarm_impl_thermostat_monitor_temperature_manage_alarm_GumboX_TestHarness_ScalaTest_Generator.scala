...
object Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX_TestHarness_ScalaTest_Generator._

trait Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX_TestHarness_ScalaTest_Generator extends Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX_TestHarness_ScalaTest
  ...
  def nextwL(profile: Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS): Option[Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_PreState_Container_PS] = {
    try {
  ...
  def testComputeCB_Profile_P(profile: Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = isolette.JSON.fromMonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_PreState_Container_P(o, T)
  ...
  def testComputeCBwL_Profile_PS(profile: Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          nextwL(profile) match {
            case Some(o) =>
              ...
              val json = isolette.JSON.fromMonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_PreState_Container_PS(o, T)
